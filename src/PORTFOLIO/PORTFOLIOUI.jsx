          ...
          <div className='about-me-susan'>
            <div className='summary-of-me'>
              <p className='about-me-details'>
                ...
                individual with background knowledge of Engineering from the
                university of Nigeria Nsukka. She has great passion for creating
                beautiful and functional websites. Furthermore, she is a good
                team player with and communicates effectively. Susan has
                experience in HTML, CSS, JavaScript and React js . <br />
                Susan is dedicated to learning and growing as a developer,
                always seeking out new challanges and opportunities to expand
                her knowledge.
                <br />
          ...
          <div className='places-of-work'>
            <div className='areas-of-work1'>
              ...
              <p className='tiidelab-explain'>
                {" "}
                Worked in a team to design and develop an e-commerce system,
                where buyers and sellers of agricultural products can transact
                business.{" "}
              </p>
            </div>
            <div className='areas-of-work1'>
              ...
              <p className='tiidelab-explain'>
                ...
                deployment. Used markup languages like HTML to create
        ...
        <section className='section project-section' id='works'>
          ...
          <section className='project-card-wrapper'>
            ...
            <div className='project-card' id='second-project'>
              <img src={adminDashboared} alt='' className='product-img' />
              ...
              <section className='card-content'>
                ...
                <p className='project-brief'>
                  {" "}
                  A dashboard the shows customers transaction
                </p>
              </section>
              <section className='project-links'>
                <a
                ...
                <a
                  href='https://admin-dashboard-rose-five.vercel.app/'
                  target='_blank'
                  rel='noreferrer'
                >
                  {" "}
 ...
 */}
            ...
            <div className='project-card' id='first-project'>
              ...
              <section className='card-content'>
                ...
                <p className='project-brief'>
                  {" "}
                  AgroEase is an e-commerce webapp for buying and selling of
              ...
              <section className='project-links'>
                ...
                <a
                  href=' https://agritec-solution.vercel.app/'
                  target='_blank'
                  rel='noreferrer'
                >
                  <FaGlobe size={35} />
